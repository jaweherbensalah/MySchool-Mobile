...
public class SignInRestauForm  extends Form{
    ComboBox<String> cp;
    public SignInRestauForm(Form previous) {
        /*
        ...
        */
        ...
        TextField tfP= new TextField("", "password");
         ...
         /* ComboBox<String> tfDA = new ComboBox<> (
          "trimestre", "semestre","année","autres");*/
           cp = new ComboBox<>();
 ...
 // cp.setRenderer(new GenericListCellRenderer<>(new MultiButton(), new MultiButton()));
